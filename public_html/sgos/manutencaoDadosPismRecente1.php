...
class manutencao{
    ...
    function execute($idTrienio = null, $anoInicial=null, $anoFinal=null, $modulo){
		...
		$output = curl_exec($ch);
		curl_close($ch);
		preg_match_all('/href="index[a-zA-Z0-9.?=&;:-]*letra=[A-Z]/i', $output, $matchsURLLetras);
		foreach($arrayLetras as $idxLetras => $forLetras){
			$arrayURLLetras[$forLetras] = "http://www4.vestibular.ufjf.br/resultfinalvest/notaspism12/miolo.ufjf.br_8594/".substr($matchsURLLetras[0][$idxLetras], 6);
		}
