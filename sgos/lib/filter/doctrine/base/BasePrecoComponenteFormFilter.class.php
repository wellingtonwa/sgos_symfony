...
/**
 * PrecoComponente filter form base class.
 *
 * @package    sgos
 * @subpackage filter
 ...
 */
abstract class BasePrecoComponenteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('preco_componente_filters[%s]');
