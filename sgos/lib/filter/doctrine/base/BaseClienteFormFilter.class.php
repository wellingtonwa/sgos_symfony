...
abstract class BaseClienteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'telefoneResidencial' => new sfWidgetFormFilterInput(),
      'telefoneComercial'   => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'idCidade'            => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Cidade'), 'column' => 'id')),
      'telefoneResidencial' => new sfValidatorPass(array('required' => false)),
      'telefoneComercial'   => new sfValidatorPass(array('required' => false)),
