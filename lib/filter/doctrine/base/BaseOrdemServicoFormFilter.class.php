...
abstract class BaseOrdemServicoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'status'             => new sfValidatorChoice(array('required' => false, 'choices' => array('Em aberto' => 'Em aberto', 'Em execução' => 'Em execução', 'Pendente' => 'Pendente', 'Cancelado' => 'Cancelado', 'Concluído' => 'Concluído'))),
